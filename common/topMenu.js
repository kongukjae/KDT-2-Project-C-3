...
function topMenu(rootChild){
  ...
  fetch("http://ec2-3-37-160-130.ap-northeast-2.compute.amazonaws.com/alarmMark", {
    method: "POST",
    body: jwt,
  })
  ...
  alarmImg.addEventListener('click', () => {
    if(tg){
      ...
      fetch("http://ec2-3-37-160-130.ap-northeast-2.compute.amazonaws.com/alarmConent", {
        method: "POST",
        body: jwt,
      })
      .then((response) => response.json())
                ...
                let callback = function(result, status) {
                  if (status === kakao.maps.services.Status.OK) {
                    ...
                    dismiss.addEventListener('click',()=>{
                      ...
                      let url = "http://ec2-3-37-160-130.ap-northeast-2.compute.amazonaws.com/deleteAlarm";
