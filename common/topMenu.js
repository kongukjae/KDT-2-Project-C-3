...
function topMenu(rootChild){
  ...
  fetch("http://43.201.52.54:2080/alarmMark", {
    method: "POST",
    body: jwt,
  })
  ...
  alarmImg.addEventListener('click', () => {
    if(tg){
      ...
      fetch("http://43.201.52.54:2080/alarmConent", {
        method: "POST",
        body: jwt,
      })
      .then((response) => response.json())
                ...
                let callback = function(result, status) {
                  if (status === kakao.maps.services.Status.OK) {
                    ...
                    dismiss.addEventListener('click',()=>{
                      ...
                      let url = "http://43.201.52.54:2080/deleteAlarm";
                    ...
                    join.addEventListener('click',()=>{
                      ...
                      async function moveToPublicChat(){
                        ...
                        await fetch(`http://43.201.52.54:2080/createPublicChatRoomRequest`,{
                          method: "POST",
