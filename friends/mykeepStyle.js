...
// form 태그를 선언해준다.
// let keepForm = document.createElement("form");
// keepForm.id = "keepForm";

// // 제목 부분과 본문 부분을 form 태그로 감싸준다.
// rootChild[1].parentNode.insertBefore(keepForm, rootChild[1]);
// keepForm.appendChild(rootChild[1]);
// keepForm.appendChild(rootChild[2]);
// console.dir(keepForm);

// // form태그의 동작방향과 방법을 설정해준다.
// keepForm.action = "/main";
// keepForm.method = "post";

// // 제목과 내용 부분 아이디 지정해주기.
// yastContentInput.id = "titleText";
// postContentInput.id = "mainText";
