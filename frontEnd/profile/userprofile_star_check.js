...
function starCheck(parent) {
  ...
  starXhr.open('POST', `http://ec2-3-37-160-130.ap-northeast-2.compute.amazonaws.com/starLoad`)
...
function starBtnCreate(parent, starValue, userID, fr_id) {
  ...
  star.addEventListener("click", () => {
    ...
    xhr.open("POST", `http://ec2-3-37-160-130.ap-northeast-2.compute.amazonaws.com/starCheck`);
