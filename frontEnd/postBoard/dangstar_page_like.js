...
function dangstarLike(postIndex, index, writerNickname){
  ...
  const _URL = `http://15.165.220.45:2080/likeCheck`;
  const likeURL = 'http://15.165.220.45:2080/dangstarLike';
  ...
  like.addEventListener('click', function(){
    ...
    // xhr.open("POST", `http://15.165.220.45:2080/postBoard/postBoardLike`, true);
