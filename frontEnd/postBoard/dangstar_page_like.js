...
function dangstarLike(postIndex, index, writerNickname){
  ...
  const _URL = `http://15.164.63.222:2080/likeCheck`;
  const likeURL = 'http://15.164.63.222:2080/dangstarLike';
  ...
  like.addEventListener('click', function(){
    ...
    // xhr.open("POST", `http://15.164.63.222:2080/postBoard/postBoardLike`, true);
