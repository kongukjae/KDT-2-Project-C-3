function main(){
  ...
  btmMeun(rootChild[5])
  // 이전채팅 불러오기
  fetch('http://43.201.52.54:2080/loadBeforeChatRequest', {
    method: 'POST',
    body:  roomCode
  ...
  function createUserOrgchat(mother,roomCode){
    ...
    exitChatRoom.addEventListener('click',()=>{
      fetch('http://43.201.52.54:2080/getOutOfPublicRoom',{
        method:'POST',
    ...
    const url = `http://43.201.52.54:2080/mapChatList`;
  ...
  //채팅
  let chat = io('http://43.201.52.54:2080/chat')
  if(firsttime==='true'){
